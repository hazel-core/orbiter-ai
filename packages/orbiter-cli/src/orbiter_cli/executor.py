"""Local agent executor for Orbiter CLI.

Wraps :func:`orbiter.runner.run` and :func:`orbiter.runner.run.stream`
...
class LocalExecutor:
    """Executes agents locally via :func:`orbiter.runner.run`.
    ...
    async def execute(
        ...
        *,
        ...
        """
        from orbiter.runner import run  # lazy import
    ...
    async def stream(
        ...
        *,
        ...
        """
        from orbiter.runner import run as run_fn  # lazy import
