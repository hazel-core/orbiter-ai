...
Context engine for the [Orbiter](../../README.md) multi-agent framework. Provides hierarchical state management, composable prompt building via neurons, event-driven processors, and workspace with artifact versioning.

## Installation

```bash
pip install orbiter-context
```
