...
FastAPI-based HTTP server for serving [Orbiter](../../README.md) agents over HTTP, SSE, and WebSocket.

## Installation

```bash
pip install orbiter-server
```

Requires Python 3.11+, `orbiter-core`, `orbiter-models`, `fastapi>=0.115`, and `uvicorn>=0.30`.
