"""WebSocket and SSE streaming for Orbiter Server.
...
def _resolve_agent(app_state: Any, name: str | None) -> Any:
    ...
    agents: dict[str, Any] = getattr(app_state, "orbiter_agents", {})
    if not agents:
        return None
    ...
    default_name: str | None = getattr(app_state, "orbiter_default_agent", None)
