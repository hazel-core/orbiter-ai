"""Tests for orbiter.mcp.server — @mcp_server() decorator and MCPServerRegistry."""
...
class TestMCPServerDecoratorRegistration:
    def test_registers_in_global_registry(self) -> None:
        with patch("orbiter.mcp.server.FastMCP"):
...
class TestMCPServerDecoratorInit:
    def test_creates_mcp_instance(self) -> None:
        ...
        with patch("orbiter.mcp.server.FastMCP", mock_fast_mcp_cls):
