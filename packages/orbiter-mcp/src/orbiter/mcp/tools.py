"""MCP tool schema extraction, conversion to Orbiter Tool format, and filtering."""
...
# ---------------------------------------------------------------------------
# MCPToolWrapper — Orbiter Tool wrapping an MCP tool
# ---------------------------------------------------------------------------


class MCPToolWrapper(Tool):
    """An Orbiter Tool that wraps an MCP tool for execution.
