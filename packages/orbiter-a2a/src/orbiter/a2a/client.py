...
from orbiter.types import AgentOutput, OrbiterError, Usage  # pyright: ignore[reportMissingImports]
...
class RemoteAgent:
    ...
    Provides the same ``run(input, ...)`` interface as ``orbiter.agent.Agent``
