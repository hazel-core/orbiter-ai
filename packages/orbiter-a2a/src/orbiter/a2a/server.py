...
from orbiter.types import OrbiterError  # pyright: ignore[reportMissingImports]
...
# ---------------------------------------------------------------------------
# Agent executor — wraps an Orbiter Agent for A2A task execution
# ---------------------------------------------------------------------------
...
class AgentExecutor:
    ...
    ``name`` attribute (i.e. an Orbiter ``Agent``).
    """
