...
class KubernetesSandbox(Sandbox):
    ...
    Requires the ``kubernetes`` extra (``pip install orbiter-sandbox[kubernetes]``).
    ...
    def __init__(
        ...
        *,
        ...
        self._namespace = namespace or os.environ.get("ORBITER_K8S_NAMESPACE", _DEFAULT_NAMESPACE)
        self._image = image or os.environ.get("ORBITER_K8S_IMAGE", _DEFAULT_IMAGE)
    ...
    def _load_client(self) -> Any:
        ...
        try:
            ...
            msg = "kubernetes package is required: pip install orbiter-sandbox[kubernetes]"
    ...
    def _pod_manifest(self) -> dict[str, Any]:
        ...
        return {
            ...
            "kind": "Pod",
            "metadata": {
                "name": f"orbiter-{self._sandbox_id}",
                "namespace": self._namespace,
                "labels": {"app": "orbiter-sandbox", "sandbox-id": self._sandbox_id},
            },
            "spec": {
                "containers": [
                    {
    ...
    def _service_manifest(self) -> dict[str, Any]:
        ...
        return {
            ...
            "kind": "Service",
            "metadata": {
                "name": f"orbiter-svc-{self._sandbox_id}",
                "namespace": self._namespace,
            },
            "spec": {
