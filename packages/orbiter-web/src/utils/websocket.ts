/**
 * Client-side WebSocket singleton for Orbiter Web.
 *
...
export class OrbiterSocket {
  // -- singleton -----------------------------------------------------------

  private static _instance: OrbiterSocket | null = null;

  static getInstance(): OrbiterSocket {
    if (!OrbiterSocket._instance) {
      OrbiterSocket._instance = new OrbiterSocket();
    }
    return OrbiterSocket._instance;
  }

  /** Reset singleton — useful for tests. */
  static resetInstance(): void {
    if (OrbiterSocket._instance) {
      OrbiterSocket._instance.close();
      OrbiterSocket._instance = null;
    }
  }
...
export const orbiterSocket = OrbiterSocket.getInstance();
