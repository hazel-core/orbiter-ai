 ...
 *   window.__orbiterApi.fetch(url, init)   — same as fetch() but with 401 handling
 *   window.__orbiterApi.expire()           — manually trigger session expiry flow
 *   window.__orbiterApi.abortAll()         — cancel all in-flight requests
 */
