"""Tests for orbiter.models.types — provider-agnostic model response types."""
...
class TestModelError:
    def test_is_orbiter_error(self) -> None:
        err = ModelError("fail")
...
class TestModelResponse:
    ...
    def test_reuses_core_types(self) -> None:
        """ModelResponse uses ToolCall and Usage from orbiter-core."""
        r = ModelResponse(
