...
LLM provider abstractions for the [Orbiter](../../README.md) multi-agent framework.
...
Requires Python 3.11+. Installs `orbiter-core`, `openai>=1.0`, `anthropic>=0.39`, and `google-genai>=1.0`.
