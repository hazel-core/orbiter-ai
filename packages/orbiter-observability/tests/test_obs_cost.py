"""Tests for orbiter.observability.cost — cost estimation and tracking."""
...
from orbiter.observability.cost import (  # pyright: ignore[reportMissingImports]
    CostEntry,
    CostTracker,
    ModelPricing,
    get_tracker,
...
class TestRecording:
    ...
    def test_record_unknown_model_zero_cost(self, caplog: pytest.LogCaptureFixture) -> None:
        t = CostTracker()
        with caplog.at_level("WARNING", logger="orbiter.cost"):
